...
public class ScheduledNotificationReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        String amount = AndroidUtils.formatCurrency(scheduledNotification.getPrice(), scheduledNotification.getCurrency());
        Notification notification = new NotificationCompat.Builder(context, CHANNEL_ID)
                .setSmallIcon(R.drawable.loop)
                .setContentText(context.getString(R.string.scheduled_notification_content, scheduledNotification.getNote(), amount))
